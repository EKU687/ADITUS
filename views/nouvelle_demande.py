...
def afficher_onglet_nouvelle_demande():
    ...
    with st.form("form_nouvelle_demande", clear_on_submit=True):
        ...
        with col1:
            site_concerne = st.selectbox(
                "📍 Site GNC concerné :",
                ["DINUM", "DOUMER", "HABITAT", "AUTRE"],
                index=0,
            )
        ...
        # Champs spécifiques au véhicule
        vehicule_immat = ""
        vehicule_type = ""
        vehicule_conducteur = ""
        ...
        if mode_acces == "Véhicule":
            ...
            with col_v3:
                vehicule_conducteur = st.text_input(
                    "🪪 Nom du conducteur :", placeholder="Nom et Prénom"
                )
            ...
            if not organisme or not motif_demande:
                ...
                try:
                    ...
                    if res.data:
                        ...
                        # Notification aux valideurs via le service mailer
                        try:
